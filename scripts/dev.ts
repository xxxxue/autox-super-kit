...
import { _src_autox_dir_path, _src_runtime_dir_path } from "./lib/config";
...
function startTransformCode(isRunProject = true) {
  // 防抖
...
const _srcDirWatcher = chokidar.watch([_src_autox_dir_path, _src_runtime_dir_path]);
