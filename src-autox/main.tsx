import * as aj from "../src-runtime/runtimeAJ";
// import { JianGuoYunUtil } from "./utils/JianGuoYunUtil";
// import { SQLiteUtil } from "./utils/SQLiteUtil";
// import { get_date_now } from "./utils/util";
// import { cloneDeep } from 'lodash-es';
// 初始化 UI
// ("aj.init_web_view_ui" 为标志位,请勿修改,
...
async function aj_fn_4(id: number, name: string, age: number) {
  ...
  // 测试 aj 调用 web
  let data = await aj.call_web_js_async("test_aj_call_web(['返回值1', '返回值2', '返回值3'])");
